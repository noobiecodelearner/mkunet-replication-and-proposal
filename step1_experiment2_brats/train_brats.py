...
if __name__ == '__main__':
    # Initial defaults
    dataset_name = 'BraTS2020'  # Experiment 2: domain generalization (neuroimaging)
    ...
    parser.add_argument('--img_size', type=int, default=256)  # matches extracted slice resolution
    ...
    parser.add_argument('--train_path', type=str, default=f'../braTS/brats_2d/train/')
    parser.add_argument('--test_path', type=str, default=f'../braTS/brats_2d/')
